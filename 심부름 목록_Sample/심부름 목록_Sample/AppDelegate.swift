...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    var myHistory = [
        ...
        history(title:"이벤트용 드라이플라워 20000원대 꽃다발 대리구매",icon:"cate3",date:"2015.07.13",pim:"minus",price:"3000",cate:"의뢰",status:"완료",bg:"001bg"),
        ...
        history(title:"명순구 교수님 민법학 원론 교재/기출 삽니다!",icon:"cate7",date:"2015.02.02",pim:"plus",price:"5000",cate:"해결",status:"완료",bg:"002bg")
    ]
